    ...
    public static partial class CustomColors
    {
        ...
        public sealed class NamesNamespace
        {
            ...
            public Dictionary<string, LabelColor> Npcs = new Dictionary<string, LabelColor>()
            {
                ...
                {"PlayerAggro", new LabelColor(new Color(255, 224, 112, 178), Color.Black, new Color(0, 0, 0, 0))},
            };
            ...
            public Dictionary<string, LabelColor> Players = new Dictionary<string, LabelColor>()
            {
                ...
                {"Guild", new LabelColor(new Color(255, 190, 214, 253), Color.Black, new Color(0, 0, 0, 0))},
                {"Party", new LabelColor(new Color(255, 190, 214, 253), Color.Black, new Color(0, 0, 0, 0))},
            };
