...
{
    public partial class EventCommand_OpenEnhancementWindow : UserControl
    {
        FrmEvent mMyEditor { get; set; }

        OpenEnhancementWindow mMyCommand { get; set; }

        public EventCommand_OpenEnhancementWindow(OpenEnhancementWindow refCommand, FrmEvent eventEditor)
        {
