    ...
    public partial class FrmPet : EditorForm
    {
        ...
        private void UpdateEditor()
        {
            if (mEditorItem != null)
            {
                ...
                nudMag.Value = mEditorItem.PetStats[(int) Stat.Intelligence];
                nudDef.Value = mEditorItem.PetStats[(int) Stat.Defense];
                nudMR.Value = mEditorItem.PetStats[(int) Stat.Vitality];
                nudSpd.Value = mEditorItem.PetStats[(int) Stat.Speed];
                nudAgi.Value = mEditorItem.PetStats[(int)Stat.Agility];
        ...
        {
            mEditorItem.DamageType = (int)(DamageType)cmbDamageType.SelectedIndex;
        }

        private void cmbScalingStat_SelectedIndexChanged(object sender, EventArgs e)
        {
            mEditorItem.ScalingStat = (int)(Stat)cmbScalingStat.SelectedIndex;
        }
        ...
        {
            mEditorItem.PetStats[(int) Stat.Attack] = (int) nudStr.Value;
        }

        private void nudMag_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PetStats[(int) Stat.Intelligence] = (int) nudMag.Value;
        }

        private void nudDef_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PetStats[(int) Stat.Defense] = (int) nudDef.Value;
        }

        private void nudMR_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PetStats[(int) Stat.MagicResist] = (int) nudMR.Value;
        }

        private void nudSpd_ValueChanged(object sender, EventArgs e)
        {
            mEditorItem.PetStats[(int) Stat.Speed] = (int) nudSpd.Value;
        }
        ...
        {
            mEditorItem.PetStats[(int)Stat.Agility] = (int)nudAgi.Value;
        }
    }
