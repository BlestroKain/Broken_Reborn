...
public partial class FrmPrisms : Form
{
    ...
    private void LoadSelected()
    {
        ...
        cmbIdleAnimation.SelectedIndex = AnimationDescriptor.ListIndex(p.IdleAnimationId ?? Guid.Empty) + 1;
        cmbVulnerableAnimation.SelectedIndex = AnimationDescriptor.ListIndex(p.VulnerableAnimationId ?? Guid.Empty) + 1;
