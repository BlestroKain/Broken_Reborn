...
Tick timer saved in server config.json.";
        ...
        public struct EventCommandList
        {
            ...
            [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
            public static LocalizedString ChangeSpawnGroup = @"Spawn Group Change: {03} on {01} (neighbors: {02})";

            [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
            public static LocalizedString ChangeSpawnGroupReset = @"Spawn Group Change: {03} on {01} (reset NPCs) (neighbors: {02})";
