        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceRate = table.Column<int>(type: "INTEGER", nullable: false),
                    StatPointsPerLevel = table.Column<int>(type: "INTEGER", nullable: false),
                    MaxLevel = table.Column<int>(type: "INTEGER", nullable: false),
                    LevelingMode = table.Column<int>(type: "INTEGER", nullable: false),
                    CanEvolve = table.Column<bool>(type: "INTEGER", nullable: false),
                    EvolutionLevel = table.Column<int>(type: "INTEGER", nullable: false),
                    EvolutionTarget = table.Column<Guid>(type: "TEXT", nullable: false),
