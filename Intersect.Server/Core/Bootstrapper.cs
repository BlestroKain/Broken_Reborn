...
namespace Intersect.Server.Core
{
    internal static class Bootstrapper
    {
        ...
        private static void PrintIntroduction()
        {
            Console.Clear();
            Console.WriteLine();
            Console.WriteLine(@" _______ _________ ______   ______   _        _______ ");
            Console.WriteLine(@"(       )\__   __/(  __  \ (  __  \ ( \      (  ____ \");
            Console.WriteLine(@"| () () |   ) (   | (  \  )| (  \  )| (      | (    \/");
            Console.WriteLine(@"| || || |   | |   | |   ) || |   ) || |      | (__    ");
            Console.WriteLine(@"| |(_)| |   | |   | |   | || |   | || |      |  __)   ");
            Console.WriteLine(@"| |   | |   | |   | |   ) || |   ) || |      | (      ");
            Console.WriteLine(@"| )   ( |___) (___| (__/  )| (__/  )| (____/\| (____/\");
            Console.WriteLine(@"|/     \|\_______/(______/ (______/ (_______/(_______/");
            Console.WriteLine(@"                                                      ");
            Console.WriteLine(@" _______  _______  _______  _______ ");
            Console.WriteLine(@"(  ___  )(  ____ \(  ____ \(  ____ \");
            Console.WriteLine(@"| (   ) || (    \/| (    \/| (    \/");
            Console.WriteLine(@"|  ___  || | ____ |  __)   (_____  )");
            Console.WriteLine(@"| (   ) || | \_  )| (            ) |");
