    ...
    public static partial class PacketSender
    {
        ...
        )
        {
            if (MapController.TryGetInstanceFromMap(mapId, instanceLayer, out var mapInstance))
            {
                ...
                {
                    SendDataToProximityOnMapInstance(mapId, instanceLayer, new PlayAnimationPacket(animId, targetType, entityId, mapId, x, y, direction, projectileHitAnim), null, TransmissionMode.Any);
                }
            }
        }
